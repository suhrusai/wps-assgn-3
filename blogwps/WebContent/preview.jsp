...
<body>
	<form action="index.jsp" id="blgpost" method="post">
		...
		<%
			...
			out.print("<input type='text' id='Blog_Title' name='Blog_Title' value='" + request.getParameter("Blog_Title")
			+ "'><br>");
			out.print("<textarea rows='10' cols='100' name='Blog_content' form='blgpost'>"
			+ request.getParameter("Blog_content") + "</textarea><br>");
		...
		<input type="checkbox" id="Approve" name="Approve" value="approve"
			checked="checked"><b>Aprrove</b><BR> <input
